...
import { Accordion, Button, Card, Container, Row, Form, FormGroup, FormLabel, Col, FormControl, InputGroup, Alert } from "react-bootstrap";
...
const ProfileButton = ({ profile, removeProfile, updatePassword, updatedPasswordAlert }: ProfileButtonProps) => {
  return (
    <>
      <Accordion>
        <Card>
